...
describe('useAssetManagement deletion cleanup', () => {
  it('immediately evicts the deleted asset from every frontend product cache and current route', async () => {
    ...
    queryClient.setQueryData<SearchResponse>(['search', 'results', 'workspace-1', 'all-assets', 'topic'], {
      ...
      resultCount: 2,
      results: [
        { assetId: 'asset-1', assetTitle: 'Delete me', transcriptRowId: 'row-1', segmentIndex: 1, startMs: null, endMs: null, text: 'topic', contextSnippet: null, createdAt: null, score: 2 },
        { assetId: 'asset-2', assetTitle: 'Keep me', transcriptRowId: 'row-2', segmentIndex: 2, startMs: null, endMs: null, text: 'topic', contextSnippet: null, createdAt: null, score: 1 },
      ],
    });
